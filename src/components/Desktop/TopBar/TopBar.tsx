  ...
  return (
    <div className="top-bar">
      ...
      <div className='middle'>
        <img className='light-dark-modes' src='/icon/contrast-icon.svg' alt='Botão para trocar tema claro e escuro'/>
      </div>

      <div className='right-side'>
        <p className='top-bar-language-button'>Change to English</p>
        <img className='top-bar-wifi-icon' src='/icon/wifi-icon.svg' alt='Ícone de Wifi'/>
