export const pt = {
    topBar: {
        ...
        settingsAlt: "Botão para abrir as preferências do portfólio",
        settingsAriaLabel: "Configurações do portfólio",
        language: "Linguagem",
    ...
    windowSidebar: {
        ...
        download: "Download",
        saveCurriculum: "Salvar currículo",
        curriculums: "Currículos",
        customLayout: "Layout Personalizado",
        simplePortuguese: "Simples Português",
